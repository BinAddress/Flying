...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		bin_f.send_status = 0;
//		BIN_DT_Send_Status(Roll,Pitch,Yaw,baroAlt,0,fly_ready);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
void BIN_DT_Send_RCData(u16 thr,u16 yaw,u16 rol,u16 pit,u16 aux1,u16 aux2,u16 aux3,u16 aux4,u16 aux5,u16 aux6)
{
	...
	bin_data_to_send[_cnt++]=BYTE1(aux1);
	bin_data_to_send[_cnt++]=BYTE0(aux1);
	bin_data_to_send[_cnt++]=BYTE1(aux2);
	bin_data_to_send[_cnt++]=BYTE0(aux2);
	bin_data_to_send[_cnt++]=BYTE1(aux3);
	bin_data_to_send[_cnt++]=BYTE0(aux3);
	bin_data_to_send[_cnt++]=BYTE1(aux4);
	bin_data_to_send[_cnt++]=BYTE0(aux4);
	bin_data_to_send[_cnt++]=BYTE1(aux5);
	bin_data_to_send[_cnt++]=BYTE0(aux5);
	bin_data_to_send[_cnt++]=BYTE1(aux6);
	bin_data_to_send[_cnt++]=BYTE0(aux6);
